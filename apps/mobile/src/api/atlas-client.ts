...
export type HistoryItem = {
  opportunityId: string; title: string; status: string; goalId?: string | null; goalTitle?: string | null; categories: string[];
  decisionReasonCode?: string | null; decisionOwnerNote?: string | null; createdAt: string; expiresAt: string; lastActionAt?: string | null;
  executionKit?: HistoryExecutionKitSummary | null; outcome?: HistoryOutcomeSummary | null; learningSummary: string;
  knowledgePackKey: string; knowledgePackVersion: string;
};
...
export function getHistory(accessToken: string, businessId: string, filters: HistoryFilters = {}): Promise<HistoryResponse> {
