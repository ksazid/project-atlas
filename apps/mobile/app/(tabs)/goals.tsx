...
export default function GoalsScreen(){
  ...
  function add(){const title=custom.trim();if(!title)return;setGoals(g=>[...g,{title,type:'custom',priority:g.length+1,isCustom:true}]);setCustom('');}
